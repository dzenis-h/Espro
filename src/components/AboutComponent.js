          ...
          <div className="about-info">
            <div clasName="container">
              <div clasName="bar">
                ...
                <div clasName="circle top"></div>
                <div clasName="circle middle"></div>
                <div clasName="circle bottom"></div>
                <div clasName="creamy">
                  <h3>Creamy</h3>
                </div>
              </div>
              <div clasName="coffee-cups">
                <div clasName="cup-small doppio">
                  <div clasName="handle"></div>
                </div>
                <div clasName="cup americano">
                  <div clasName="handle"></div>
                </div>
                <div clasName="cup-small macchiato">
                  <div clasName="handle"></div>
                </div>
                <div clasName="cup-small flatwhite">
                  <div clasName="handle"></div>
                </div>
                <div clasName="cup cappuccino">
                  <div clasName="handle"></div>
                </div>
                <div clasName="cup-long latte">
                  <div clasName="handle"></div>
                  <div clasName="bottom-handle"></div>
                </div>
              </div>
              <div clasName="info">
                <div clasName="first">
                ...
                <div clasName="fifth">
                  <h1>Cappuccino</h1>
                  <p>
                    Double shot of espresso topped with an airy thick layer of
                    foamed milk.
                  </p>
                </div>
                <div clasName="sixth">
            ...
            <div className="bio">
              ...
              <small className="about-parts">
                ...
                Italy's top premium coffee roasters. The company is ran by
                ...
                uses his Erbisti's original roasting machine, making him almost
                certainly the last roasters in the world to roast his beans
                directly with an open flame. The family philosophy remains the
                same, eschewing dark roasts in order to preserve even the
                subtlest aromas of the coffee. Simone is obsessive about
                sourcing his beans and insists on specifying the exact means of
                production at every stage of the process.
              </small>
              <small>
                <blockquote
                  className={
                ...
                <p className="about-parts">
                  ...
                  coffee shot. Typically you will find a pump system on top that
                  will ensure that not even the smallest residuals of weighted
                  coffee is retained.
                </p>
                <hr />
                <blockquote
