...
const Contact = () => {
  ...
  useEffect(() => {
    document.title = "Contact Us"; // making the document title dynamic
  }, []);
  ...
  const sendData = (e) => {
    ...
    axios // Make the request to the backend
      .post("", { formData: userInput }) // e.g. "http://localhost:5050/form-data"
  ...
  const { name, phone, email, company, message } = userInput;
        ...
        <div className="contact-container">
          <div className="wrapper animate__animated bounceInLeft">
            <div className="company-info">
              ...
              <small className="blue-label lead">
              ...
              <ul className="contact-list">
                ...
                <SideLink
                  ...
                  text="Call us by Phone"
                />
                <SideLink
                  link="skype:dzenis.hankusic?call"
                  linkAlt="Skype field"
                  icon="fab fa-skype"
                  text="Call us via Skype"
                />
              </ul>
            </div>
            ...
            <div className="contact">
              ...
              <p className="contact-plus">
                For any queries please contact us using this form or by other
